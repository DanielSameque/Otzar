...
mixin _$HealthStatus {
 ...
 String get status; String get database; DateTime get timestamp;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HealthStatus&&(identical(other.status, status) || other.status == status)&&(identical(other.database, database) || other.database == database)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,database,timestamp);

@override
String toString() {
  return 'HealthStatus(status: $status, database: $database, timestamp: $timestamp)';
}
...
@useResult
$Res call({
 String status, String database, DateTime timestamp
});
...
/// Create a copy of HealthStatus
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? database = null,Object? timestamp = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String database,  DateTime timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HealthStatus() when $default != null:
return $default(_that.status,_that.database,_that.timestamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String database,  DateTime timestamp)  $default,) {final _that = this;
switch (_that) {
case _HealthStatus():
return $default(_that.status,_that.database,_that.timestamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String database,  DateTime timestamp)?  $default,) {final _that = this;
switch (_that) {
case _HealthStatus() when $default != null:
return $default(_that.status,_that.database,_that.timestamp);case _:
  return null;
...
class _HealthStatus implements HealthStatus {
  const _HealthStatus({required this.status, required this.database, required this.timestamp});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HealthStatus&&(identical(other.status, status) || other.status == status)&&(identical(other.database, database) || other.database == database)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}
...
/// Create a copy of HealthStatus
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? database = null,Object? timestamp = null,}) {
